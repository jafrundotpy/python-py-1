...
root=Tk()
root.title("Employee Management System created by Jafrun")
root.geometry("1290x1080+0+0")
...
btnAdd=Button(btn_frame,command=add_employee,text="Add Details", width=15,font=("calibri", 14, "bold"), fg="white",
              bg="#16a085",bd=0).grid(row=0,column=0)

btnEdit=Button(btn_frame,command=update_employee,text="Update Details", width=15,font=("calibri", 14, "bold"), fg="white",
              bg="#2980b9",bd=0).grid(row=0,column=1, padx=10)

btnDelete=Button(btn_frame,command=delete_employee,text="Delete Details", width=15,font=("calibri", 14, "bold"), fg="white",
              bg="#c0392b",bd=0).grid(row=0,column=2, padx=10)

btnClear=Button(btn_frame,command=clearAll,text="Clear Details", width=15,font=("calibri", 14, "bold"), fg="white",
...
style.configure("mystyle.Treeview.Heading", font=('calibri', 16)) #Modify the font of Headings
